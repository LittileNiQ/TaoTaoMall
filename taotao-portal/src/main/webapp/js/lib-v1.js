...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		//URL_Serv: "http://localhost:8082/category.json",               2    自动将请求方法做参数在jQuery后面加上        加载这句话之后做请求
       ...
       /* var a, b = {}, c = $("#categorys-2013");
    	...
    	//使用jsonp来实现跨域请求
    	           //请求的url              回调方法                           请求的时候会自动地把回调方法作为参数在jquery后面加上做请求。 
        $.getJSONP(this.URL_Serv, category.getDataService);//请求json，不返回json数据，返回脚本。返回脚本  方法先定义好的            1 
    	//直接使用ajax请求json数据
      ...
      //  $.getJSONP(this.URL_BrandsServ, category.getBrandService)
    },getDataService: function(a) {           //3 将该方法作为参数传递给服务端        a就是我们要得到的是参数 
        var b = [], c = this;
